...
import CheckConfigRequestWebInfo, { ICheckConfigRequestWebInfo } from './CheckConfigRequestWebInfo';
...
export interface ICheckConfigRequest {
    ...
    web?: ICheckConfigRequestWebInfo;
}
...
export default class CheckConfigRequest {
    ...
    readonly _web: CheckConfigRequestWebInfo | undefined;

    get web(): CheckConfigRequestWebInfo | undefined {
        return this._web;
    }
    ...
    constructor(props: ICheckConfigRequest) {
        ...
        if (props.web) {
            this._web = new CheckConfigRequestWebInfo(props.web);
        }
    }
