...
export interface ICheckConfigRequestWebInfo {
    autofix?: boolean;
    ip?: string[];
    port?: number;
}

export default class CheckConfigRequestWebInfo {
    ...
    constructor(props: ICheckConfigRequestWebInfo) {
    ...
    serialize(): ICheckConfigRequestWebInfo {
        const data: ICheckConfigRequestWebInfo = {
        };
    ...
    update(props: Partial<ICheckConfigRequestWebInfo>): CheckConfigRequestWebInfo {
        return new CheckConfigRequestWebInfo({ ...this.serialize(), ...props });
    }
}
